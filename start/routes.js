...
Route.group(() => {
  ...
  Route.get('get-admin-users', 'AuthController.getUsersFromAdmin').middleware(['TokenKey'])
  Route.get('get-admin-tenants', 'AuthController.getTenantsFromAdmin').middleware(['TokenKey'])
  Route.post('admin-crea-utente', 'AuthController.creaUtente').middleware(['TokenKey'])
  Route.post('admin-elimina-utente', 'AuthController.eliminaUtente').middleware(['TokenKey'])
  Route.post('admin-modifica-utente', 'AuthController.modificaUtente').middleware(['TokenKey'])
  
  Route.post('admin-crea-tenant', 'AuthController.creaTenant').middleware(['TokenKey'])
  Route.post('admin-elimina-tenant', 'AuthController.eliminaTenant').middleware(['TokenKey'])
  Route.post('admin-modifica-tenant', 'AuthController.modificaTenant').middleware(['TokenKey'])  
}).prefix('/api/auth/')
...
//Controparte Commerciale
Route.group(() => {
  Route.get('att-dis-pod','RcuGasUddController.andamentoAttDisatPod').middleware(['TokenKey','Permissions:rcu-ee-cc'])
  Route.get('att-dis-volumi','RcuGasUddController.andamentoAttDisatVolumi').middleware(['TokenKey','Permissions:rcu-ee-cc'])
...
//Utente del dispacciamento
Route.group(() => {
  Route.get('business-unit','RcuGasCcController.businessUnit').middleware(['TokenKey','Permissions:rcu-gas-cc'])
  Route.get('sub-business-unit','RcuGasCcController.subBusinessUnit').middleware(['TokenKey','Permissions:rcu-gas-cc'])
  Route.get('italy-map','RcuGasCcController.italyMap').middleware(['TokenKey','Permissions:rcu-gas-cc'])
  Route.get('status-cache','RcuGasCcController.statusCache').middleware(['TokenKey','Permissions:rcu-gas-cc'])
  Route.get('refresh-cache','RcuGasCcController.refreshCache').middleware(['TokenKey','Permissions:rcu-gas-cc'])
  Route.get('delete-cache','RcuGasCcController.deleteCache').middleware(['TokenKey','Permissions:rcu-gas-cc'])
  Route.get('att-dis-pod','RcuGasCcController.andamentoAttDisatPod').middleware(['TokenKey','Permissions:rcu-gas-cc'])
  Route.get('att-dis-volumi','RcuGasCcController.andamentoAttDisatVolumi').middleware(['TokenKey','Permissions:rcu-gas-cc'])
  ...
  Route.get('table-tasso-abbandono','RcuGasCcController.tableTassoAbbandono').middleware(['TokenKey','Permissions:rcu-gas-cc'])
  
  Route.get('table-tasso-abbandono-volumi','RcuGasCcController.tableTassoAbbandonoVolumi').middleware(['TokenKey','Permissions:rcu-gas-cc'])
  ...
  Route.post('italy-map-export','RcuGasCcController.exportFormMap').middleware(['TokenKey','Permissions:rcu-gas-cc'])
  Route.post('fatturazione-file','RcuGasCcController.uploadZip').middleware(['TokenKey','Permissions:rcu-gas-cc'])
  Route.get('force-update', 'RcuGasCcController.updateDatamaxDb')
